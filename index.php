...
<body>
  ...
  <div class="py-5 text-center" style="background-image: url(&quot;https://pingendo.github.io/templates/sections/assets/cover_event.jpg&quot;);">
    <div class="container py-5">
      <div class="row">
        <div class="col-md-12">
          <h1 class="display-3 mb-4 text-primary">Estamos chegando</h1>
          <p class="lead mb-5">Um novo conceito está em contrução.
            <br>Aguarde.</p>
        </div>
      </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="col-md-12">
          ...
          <form class="form-inline">
            <div class="form-group">
              <input type="email" class="form-control" placeholder="Informe seu email"> </div>
      ...
      <div class="row">
        <div class="col-md-12 mt-3 text-center">
          <p>© Copyright 2017 Z3ta Sistemas - Todos os direitos reservados.</p>
        </div>
      </div>
    </div>
  </div>
